...
//   const [viewersToDisplayInModal, setViewersToDisplayInModal] = useState(null);
...
//   const chatInputRef = useRef(null); // Ref for the contenteditable div
...
//             !chatInputRef.current.querySelector(`[data-user-id="${user.id}"]`) // Check if bubble already exists
//         )
...
//     // Find the start of the "@" symbol and the partial name that needs to be replaced
//     let startOfReplacement = -1;
//     if (textNode.nodeType === Node.TEXT_NODE) {
//       const textBeforeCaret = textNode.textContent.substring(0, caretOffset);
//       startOfReplacement = textBeforeCaret.lastIndexOf("@");
//     }

//     if (startOfReplacement === -1) {
//       setShowMentions(false);
//       return;
//     }

//     // Create a new range to select and delete the "@" and partial name
//     const deleteRange = document.createRange();
//     deleteRange.setStart(textNode, startOfReplacement);
//     deleteRange.setEnd(textNode, caretOffset);
//     deleteRange.deleteContents(); // Delete the "@" and partial name

//     // Get the current insertion point after deletion
//     const insertionPoint = deleteRange.startContainer;
//     const insertionOffset = deleteRange.startOffset;

//     // Create the mention bubble span
//     const mentionSpan = document.createElement("span");
//     mentionSpan.contentEditable = "false";
//     mentionSpan.className =
//       "mention-bubble inline-flex items-center rounded-full px-2 py-0.5 text-sm font-medium bg-custom-mention-bg text-custom-mention-text cursor-pointer";
//     mentionSpan.style.userSelect = "none";
//     mentionSpan.textContent = user.name;
//     mentionSpan.dataset.userId = user.id;

//     // Create a non-breaking space node after the mention
//     const spaceNode = document.createTextNode("\u00A0");

//     // Insert the mention bubble and space at the current insertion point
//     if (insertionPoint.nodeType === Node.TEXT_NODE) {
//       // If inserting into a text node, split it and insert elements
//       const remainingText = insertionPoint.splitText(insertionOffset);
//       insertionPoint.parentNode.insertBefore(mentionSpan, remainingText);
//       insertionPoint.parentNode.insertBefore(spaceNode, remainingText);
//     } else {
//       // If inserting into an element (like the contenteditable div itself)
//       insertionPoint.insertBefore(
//         mentionSpan,
//         insertionPoint.childNodes[insertionOffset] || null
//       );
//       insertionPoint.insertBefore(spaceNode, mentionSpan.nextSibling);
//     }

//     // Reposition the caret after the inserted space
...
//           Math.min(filteredMentions.length - 1, prev + 1)
//         );
...
//                             className="rounded-md max-w-full h-auto object-cover max-h-[150px] cursor-pointer"
//                             onClick={() =>
...
//                   viewersToDisplayInModal.map((viewer) => (
//                     <motion.div
//                       key={viewer.id}
